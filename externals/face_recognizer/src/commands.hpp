...
#define DECLARE_COMMAND s_commands.push_back(this);
  ...
  static const CommandRegister cmdRegister("register", 1);
  static const CommandSleep cmdSleep("sleep", 0);
  static const CommandWakeup cmdWakeup("wakeup", 0);
  static const CommandStop cmdStop("stop", 0);
